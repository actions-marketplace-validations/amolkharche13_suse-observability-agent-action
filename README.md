...
## Prerequisites
1. Access to the cluster, add the **KUBECONFIG** secret in your repository by navigating to Settings → Secrets and variables → Actions.

2. Obtain an API Key from your SUSE Observability cluster.
